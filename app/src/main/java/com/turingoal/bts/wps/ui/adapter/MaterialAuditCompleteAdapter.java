 ...
 * 已审核列表的adapter
 */
public class MaterialAuditCompleteAdapter extends BaseQuickAdapter<MaterialUsage, BaseViewHolder> {
    public MaterialAuditCompleteAdapter() {
        super(R.layout.app_item_material_audit_complete);
    }
